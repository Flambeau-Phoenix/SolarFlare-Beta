...
class GameIcons {
	...
	/** True when a baked atlas frame backs this key. Map lookups only — safe in draw. */
	public static function hasKey(id:String):Bool {
		return id != null && id.length > 0 && getFrame(id) != null;
	}
