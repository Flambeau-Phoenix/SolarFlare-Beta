...
class WindowEffects {
	 ...
	 * @param showReflect bottom light strip; disable for HUD chrome (reads as a ghost bar).
	 */
	public static function glassPanel(dl:Dynamic, minX:Float, minY:Float, maxX:Float, maxY:Float, baseColor:Int, glassiness:Float = 0.3,
			showReflect:Bool = true):Void {
		var w = maxX - minX;
		var h = maxY - minY;
